...
Several regional studies link forest treatment to changes in stand-level ecohydrology, including increased tree growth in Ponderosa Pines (**Rodman et al., 2024**) greater soil moisture and total ecosystem moisture leading to increased drought resilience [@sankey_regionalscale_2021; @sankey_thinning_2022], increased snow retention [@broxton_subseasonal_2023; @belmonte2021], greater streamflow [@baker_effects_1986], water table rise \[Denver et al in Prep \][@smerdon_overview_2009][@schenk_impacts_2020] and increased springflow [@schenk_impacts_2020]\[Hart prarie and hoxworth in prep\].
